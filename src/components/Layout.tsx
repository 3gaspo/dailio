...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="min-h-screen bg-[#FDFDFD] dark:bg-[#0A0A0A] text-[#1A1A1A] dark:text-[#FDFDFD] pb-20 font-sans transition-colors duration-300">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#111111] border-t border-black/5 dark:border-white/5 px-6 py-3 z-50 transition-colors duration-300">
